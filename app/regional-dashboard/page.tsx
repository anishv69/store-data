...
export default function RegionalDashboardPage() {
  ...
  return (
    <AppShell session={session}>
      ...
      <AggregationExplorer title="Regional sales aggregation" description={`Explore state, city, and product performance inside the ${data.region} region. Access remains restricted to your assigned region.`} />
    </AppShell>
  );
}
