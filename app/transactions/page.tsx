...
export default function TransactionsPage() {
  ...
  return (
    <AppShell session={session}>
      ...
      <div className="mb-5 grid gap-4 sm:grid-cols-2"><div className="panel flex items-center gap-4 p-5"><span className="flex size-11 items-center justify-center rounded-xl bg-[#eaf3ff] text-[#0071e3]"><ReceiptText size={20}/></span><div><p className="eyebrow">Completed sales</p><p className="mt-1 text-2xl font-bold">{rows.length}</p></div></div><div className="panel p-5"><p className="eyebrow">Recorded revenue</p><p className="mt-1 text-2xl font-bold">{currency(total)}</p></div></div>
